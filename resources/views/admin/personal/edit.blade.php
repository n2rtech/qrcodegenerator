@extends('admin.app')
@section('title', 'Edit Personal User')
@section('content')
    <!-- start page title -->
    <div class="row">
        <div class="col-12">
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <div class="row mb-3">
                        <div class="col-md-4">
                            <h4 class="mt-2">Edit Personal User</h4>
                        </div>
                        <div class="col-md-8 text-right">
                            <a href="{{ url()->previous() }}" class="btn btn-dark btn-sm">Back </a>
                            <button type="submit" class="btn btn-success btn-sm" form="personalUserForm"><i class="mdi mdi-content-save"></i> Update </button>
                        </div>
                    </div>
                </div>
                <div class="card-body">
                    <form class="form-horizontal" id="personalUserForm" action="{{ route('admin.personal-users.update', $user->id) }}" method="POST"
                        ...
                        <div class="form-group row mb-3">
                            ...
                            <div class="col-9">
                                <input type="text" name="address_1"
                                    value="{{ old('address_1', isset($user) ? $user->mailingAddress['address_1'] : '') }}"
                        ...
                        <div class="form-group row mb-3">
                            ...
                            <div class="col-9">
                                <input type="text" name="address_2"
                                    value="{{ old('address_2', isset($user) ? $user->mailingAddress['address_2'] : '') }}"
                        ...
                        <div class="form-group row mb-3">
                            ...
                            <div class="col-9">
                                <input type="text" name="city"
                                    value="{{ old('city', isset($user) ? $user->mailingAddress['city'] : '') }}"
                        ...
                        <div class="form-group row mb-3">
                            ...
                            <div class="col-9">
                                <input type="text" name="state"
                                    value="{{ old('state', isset($user) ? $user->mailingAddress['state'] : '') }}"
                        ...
                        <div class="form-group row mb-3">
                            ...
                            <div class="col-9">
                                <input type="text" name="zipcode"
                                    value="{{ old('zipcode', isset($user) ? $user->mailingAddress['zipcode'] : '') }}"
                        ...
                        <div class="form-group row mb-3">
                            ...
                            <div class="col-9">
                                <select type="text" class="form-control" id="country" name="country">
                                    ...
                                    <option class="United States of America" @if ($user->mailingAddress['zipcode'])) == 'United States of America' selected @endif)>United States of
                                        America</option>
