                        ...
                        <div class="form-group row mb-3">
                            ...
                            <div class="col-9">
                                <fieldset class="rating">
                                    <input type="radio" id="star5" name="rating" value="5" @if($enquiry->rating == 5) checked @endif/>
                                    <label class="full" for="star5" title="Awesome - 5 stars"></label>

                                    <input type="radio" id="star4half" name="rating" value="4.5"  @if($enquiry->rating == 4.5) checked @endif/>
                                    <label class="half" for="star4half" title="Pretty good - 4.5 stars"></label>

                                    <input type="radio" id="star4" name="rating" value="4"  @if($enquiry->rating == 4) checked @endif/>
                                    <label class="full" for="star4" title="Pretty good - 4 stars"></label>

                                    <input type="radio" id="star3half" name="rating" value="3.5"  @if($enquiry->rating == 3.5) checked @endif/>
                                    <label class="half" for="star3half" title="Meh - 3.5 stars"></label>

                                    <input type="radio" id="star3" name="rating" value="3"  @if($enquiry->rating == 3) checked @endif/>
                                    <label class="full" for="star3" title="Meh - 3 stars"></label>

                                    <input type="radio" id="star2half" name="rating" value="2.5"  @if($enquiry->rating == 2.5) checked @endif/>
                                    <label class="half" for="star2half" title="Kinda bad - 2.5 stars"></label>

                                    <input type="radio" id="star2" name="rating" value="2"  @if($enquiry->rating == 2) checked @endif/>
                                    <label class="full" for="star2" title="Kinda bad - 2 stars"></label>

                                    <input type="radio" id="star1half" name="rating" value="1.5"  @if($enquiry->rating == 1.5) checked @endif/>
                                    <label class="half" for="star1half" title="Meh - 1.5 stars"></label>

                                    <input type="radio" id="star1" name="rating" value="1"  @if($enquiry->rating == 1) checked @endif/>
                                    <label class="full" for="star1" title="Sucks big time - 1 star"></label>

                                    <input type="radio" id="starhalf" name="rating" value="0.5"  @if($enquiry->rating == 0.5) checked @endif/>
